...
class MotionRepository(context: Context) {
    //Hier wird der SensorManager initialisiert
    private val sensorManager = context.getSystemService(Context.SENSOR_SERVICE) as SensorManager
//
    /**Der Schrittzähler wird mittlerweile über hinterlegte Distanz berechnet und ungefähr ausgegeben
     * wir können es nicht testen mit dem Emulator oder zumindest haben wir keinen Weg gefunden es zu testen **/
